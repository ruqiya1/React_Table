...
class App extends React.Component {
  ...
  render() {
    ...
    const saveUser = () => {
      let res = this.state.list.map((v) =>
        v.id == this.state.selected.id ? this.state.selected : v
      );
                ...
                <div className="mapDiv">
                  ...
                  <div className="btnWrap right">
                    {slc ? (
                      ...
                      <button onClick={() => editUser(v)} className="btn">
                        Edit
                      </button>
                    )}
                    {slc == false && (
                      <button onClick={() => deleteUser(v.id)} className="btn">
                        Delete
                      </button>
                    )}
                  </div>
